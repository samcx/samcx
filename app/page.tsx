export default function Home() {
  return (
    <main>
      <div>
        <p className="quote">
          <em>Eat at a local resturant tonight.</em> Get the cream sauce. Have a
          cold pint at 4 o&apos;clock in a mostly empty bar.{' '}
          ...
          server. <em>Check in</em> on your [family and] and friends. Check in
          on yourself. <em>Enjoy the ride.</em>
        </p>
      </div>
    </main>
  )
